...
(function($){
	...
	function Brickfolio(element, options){
		...
		_.defaults = {
			...
			imageSelector: 'img:first', // the jQuery selector to find the main images within an item. Assuming default values this would be ".bf-item img:first"
			...
			hideErrors: false, // automatically hides any items where the images has failed to load
		...
		/**
		 * This function is only here because of IE not supporting late binding to the images error event.
		 * To work around this you have to reset the src after binding, initially this may look expensive but if the images is already loaded IE will simply fetch it from the cache.
		 * @param {*} $img - The jQuery images object.
		 */
